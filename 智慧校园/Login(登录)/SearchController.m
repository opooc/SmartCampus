...
- (void)viewDidLoad {
    ...
    DJRegisterView *SearchView = [[DJRegisterView alloc]
                                initwithFrame:self.view.bounds djRegisterViewTypeSMS:DJRegisterViewTypeNoScanfSMS plTitle:@"请输入手机号"
                                title:@"下一步"
...
//                                        if (isSuccessful) {
                                    ...
                                    if (isPhone) {
                                        ...
                                        UpdataController* updata = [[UpdataController alloc]init];
                                        updata.UPhoneNum = yzmStr;
